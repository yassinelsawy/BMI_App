        ...
        child: Column(
          ...
          Row(
            ...
            Container(
                  ...
                  Column(
                    ...
                    children: [
                      Flexible(
                        ...
                        child: IconButton( icon: Icon(Icons.male, color: gender == 'male'? const Color(0xff76ABAE):const Color(0xff000000),size: 30,),
                    ...
                    Container(
                    margin: const EdgeInsets.only(left: 20),
                      child: IconButton( icon: Icon(Icons.female, color: gender == 'female'? Colors.pink:const Color(0xff000000), size: 30,),
              ...
              Container(
              margin: const EdgeInsets.only(top: 20),
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), color: Color(0xffFFFFFF)),
              width: 302,
              height: 141,
              child: const SingleChildScrollView(
                child: Column(children: [
                  Text("Your Result is", style: TextStyle(color: Color(0xff000000), fontSize: 20, fontWeight: FontWeight.w700),),
                  
                  Text("00", style: TextStyle(color: Color(0xff000000), fontSize: 64, fontWeight: FontWeight.w700),),
                  Text("Normal", style: TextStyle(color: Color(0xff000000), fontSize: 20, fontWeight: FontWeight.w700),),
                ],),
              ),
              ),
              Container(
              ...
              width: 100,
              height: 22,
              child: const Center(child: Text("Calculate" , style: TextStyle(color:  Color(0xff000000), fontSize: 16,fontWeight: FontWeight.w700, ),)),
              ),  
          ],),
      ),  
    );
